...
{
var fnameverify=/^([a-zA-Z]){2,8}$/;
var lnameverify=/^([a-zA-Z]){2,8}$/;
var emailverify=/^(([a-zA-Z0-9_\-\.]+)@([a-zA-Z]{1,5}){2,20})$/;
var phnonumverify=/^([+]){1}([0-9]){1,2}([0-9]){2,10}$/;
...
else if(fnameverify.test(fname)==true)
{
	return false;
}
else
...
else if(lnameverify.test(fname)==true)
{
	return false;
}
else 
...
else if(emailverify.test(email)==true)
{
return false;
}		
else
...
else if(phnonumverify.this(phonum)==true)
{
	return false;
}
else
...
else if(address1verify.this(addrss1)==true)
{
	return false;
}
else
...
else if(address2verify.this(addrss2)==true)
{
	return false;
}
else
...
else if(cityverify.this(city)==true)
{
	return false;
}		
else
...
else if(stateverify.this(state)==true)
{
	return false;
}	
else
...
else if(zipverify.this(zipcode)==true)
{
	return false;
}
else
...
else if(pswd1verify.this(cratpswd)==true)
{
	return false;
}
else
...
else if(pswd2verify.this(vrfypswd)==true)
{
	return false;
}
else
